...
<div class="account-pages">
    <div class="wrapper-page">
        <div class="text-center">
            <a href="${pageContext.request.contextPath}/Users/registerteacher" class="logo"><span>教师注册<span>前往</span></span></a>
        </div>
            ...
            <div class="panel-body">
                <form class="am-form" action="${pageContext.request.contextPath}/Users/registerIn" method="post">
                    <div class="am-g">
                        ...
                        <div class="am-form-group form-horizontal m-t-20">
                            班级:<input type="text" class="am-radius"  placeholder="班级" name="classes"/>
                        </div>

                        <div class="am-form-group form-horizontal m-t-20">
                            姓名:<input type="text" class="am-radius"  placeholder="姓名" name="name"/>
                        </div>

                        <div class="am-form-group form-horizontal m-t-20">
                            年龄:<input type="text" class="am-radius"  placeholder="年龄" name="age"/>
                        </div>
